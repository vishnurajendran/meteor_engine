...
private:
    ...
    // Per-asset-id mutable edit buffers for text assets.
    // ImGui's InputTextMultiline requires a char* buffer with a fixed capacity.
    static std::map<SString, std::vector<char>> textEditBuffers;
};
