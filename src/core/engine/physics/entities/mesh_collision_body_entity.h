...
class MMeshCollisionBody : public MSpatialEntity, public IPhysicsCallbackReceiver
{
    ...
    // Explicit asset override — if set, takes priority over child auto-pickup.
    // Leave empty to have the entity scan children for a MStaticMeshEntity.
